...
The string which will be translated will be 'Hello %s.' and `'restimel'` will be given as first argument in formatter.
...
Options are sthe same as in [i18n.getLocale](#i18ngetlocaleoptions).
